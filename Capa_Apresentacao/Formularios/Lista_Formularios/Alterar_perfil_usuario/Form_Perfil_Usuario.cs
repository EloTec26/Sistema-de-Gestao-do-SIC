    ...
    public partial class Form_Perfil_Usuario : Form
    {
        ...
        private void btn_salvar_Click(object sender, EventArgs e)
        {
            if(text_primeiro_nome.Text == "" || text_ultimo_nome.Text == "" || text_sexo.Text == ""
                || text_numero_bi.Text == "" || label_telefone1.Text == "" ||text_palavra_passe.Text == "")
            {
                MessageBox.Show("Todos os campos com (*) são de preenchimento obrigatório!", "Erro ao atualizar o perfil",
            ...
            else
            {
                try
                {
                    ...
                    if(MessageBox.Show("Tens a certeza de atualizar os dados do seu perfil?", "Mensagem de atualização do perfil",
                        MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        d_Usuarios.atualizar_usuarios(c_Usuarios);
                        MessageBox.Show("O seu perfil foi atualizado com sucesso!", "Atualização bem sucedida",
                ...
                {
                    MessageBox.Show("Não foi possível atualizar o seu perfil" +
                        ".....................................................................", Ex.Message);
                }
            }
