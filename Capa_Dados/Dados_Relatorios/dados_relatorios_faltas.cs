...
{
    public class dados_relatorios_faltas : conexao_sql
    {
        public DataTable relatorioFaltas(DateTime? dataInicial = null, DateTime? dataFinal = null)
        {
